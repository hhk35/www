<? 
	...
	$sql = "select * from job where num=$num";
	...
	$sql = "update job set hit=$new_hit where num=$num";   // 글 조회수 증가시킴
...
?>			
			...
			<div id="ripple_box">
				<div id="ripple_box1"><strong>COMMENTS</strong></div>
				<div id="ripple_box2"><textarea rows="5" cols="65" name="ripple_content"></textarea>
				</div>
				<div id="ripple_box3"><button>등록</button></div>
			</div>
			</form>
		</div> <!-- end of ripple -->
